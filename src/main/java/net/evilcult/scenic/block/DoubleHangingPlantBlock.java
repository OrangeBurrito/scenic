...
public class DoubleHangingPlantBlock extends DoublePlantBlock {
    ...
    public BlockState getStateForPlacement(@Nonnull BlockItemUseContext context) {
        ...
        return blockpos.getY() < context.getWorld().getHeight() - 1 && context.getWorld().getBlockState(blockpos.down()).isReplaceable(context) ? this.getDefaultState() : null;
    }//removed getDimension after getworld
